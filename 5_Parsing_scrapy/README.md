В этой папке находиться парктическое задание по теме Урок 5. Scrapy
...
II вариант (не тестировался до конца, возможны проблемы с недоступностью некоторых данных)
